...
namespace TestFramework
{
    public static class WebDriverFactory
    {
        public static IWebDriver InitiateBrowser(string browserName, string language)
        {
            ...
            {
                case "chrome":
                    return SetUpChromeBrowser(language);

                case "firefox":
                    return SetUpFirefoxBrowser(language);
        ...
        private static IWebDriver SetUpChromeBrowser(string language)
        {
        ...
        private static IWebDriver SetUpFirefoxBrowser(string language)
        {
